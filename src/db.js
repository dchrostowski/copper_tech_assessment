...
var MONGO_USERNAME = 'stockbot';
var MONGO_PASSWORD = 'password';
var MONGO_HOSTNAME = 'localhost';
var MONGO_PORT = 4001;
var MONGO_DB = 'stocks';
var url = "mongodb://".concat(MONGO_USERNAME, ":").concat(MONGO_PASSWORD, "@").concat(MONGO_HOSTNAME, ":").concat(MONGO_PORT, "/").concat(MONGO_DB, "/").concat(MONGO_DB, "?authSource=admin");
